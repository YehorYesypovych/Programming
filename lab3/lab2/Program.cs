...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Новий час після додавання {secondsToAdd} секунд: {newTime.Hours:D2}:{newTime.Minutes:D2}:{newTime.Seconds:D2}");
        ...
        Console.WriteLine($"Завантажений об'єкт: {loadedTime.Hours:D2}:{loadedTime.Minutes:D2}:{loadedTime.Seconds:D2}");
    }
}
